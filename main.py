...
st.markdown(
    ...
    Visando oferecer uma análise detalhada e interativa dos principais indicadores do projeto, apresentamos os dashboards gerados, incluindo gráficos como Ponto de Virada com Variação Percentual, Categorização do INDE e Evolução do INDE ao Longo dos Anos. Cada gráfico está organizado em sua própria aba, possibilitando a exploração dinâmica dos dados, com a interação direta nos gráficos para obter insights personalizados e visualizar tendências e resultados educacionais de maneira mais envolvente.\n
    </p>
    """,
